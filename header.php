			...
			<div class="top-line">
				<div class="container">
					...
					<div class="right-line clearfix">
						<ul>
							<?php
								if(isset($_SESSION["User"]["idclients"])) : 
							?>
							<li><a href="#">My Account</a></li>
							<li><a href="#">My Wishlist</a></li>
							<li><a href="http://localhost/gregoire_morane/php-object/php-object-wf3/logout">Checkout</a></li>
							<?php
								else :
							?>
				        ...
				        <div id="login-box" class="login-popup">
				        	<a href="#" class="close"><img src="<?php echo HOST.FOLDER ?>images/delete.png" class="btn_close" title="Close Window" alt="Close" /></a>
				         	<form method="post" class="signin" action=" http://localhost/gregoire_morane/php-object/php-object-wf3/user-register">
