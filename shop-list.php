					        	...
					        	<div class="grid-item2 mb30">
					        		...
					        		<div class="row">
										...
										<div class="arrival-overlay col-md-4">
											<a href="<?php echo HOST.FOLDER."single/".$item["iditems"] ?>"><img src="<?php echo $item["url"] ?>" alt=""></a>
										</div>
										...
										<div class="col-md-8">
											<div class="list-content">
												...
												<div class="list-downrow">
													...
													<a href="#" class="medium-button button-red add-cart " id="items-<?php echo $item['iditems'] ?>">Add to Cart</a>
